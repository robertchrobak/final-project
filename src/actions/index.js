...
export function fetchFoodItems(foodSubmission) {
  console.log("Action", foodSubmission);
    ...
    return function(dispatch) {
        ...
        // $.get("https://api.nutritionix.com/v1_1/search/apple?fields=item_name%2Citem_id%2Cbrand_name%2Cnf_calories%2Cnf_total_fat&appId=adfc65c6&appKey=a4e2e4f78ba1945fb06847d48cffed03", function(data) {
            ...
            const foodItem = { food: data.hits[0].fields.item_name, calories: data.hits[0].fields.nf_calories, meal: "" };
